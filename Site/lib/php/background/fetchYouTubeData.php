<script type="text/javascript">
  ...
  function getYouTubeDescription( data )
  {
    document.writeln( '<br/>' + data.entry[ "media$group" ][ "media$description" ].$t.replace( /\n/g, '<br/>' ) + '<br/>' );
  }
...
<?php
	...
	function printYouTubeDescription($id)
	{
		echo "<script type='text/javascript' src='http://gdata.youtube.com/feeds/api/videos/$id?v=2&amp;alt=json-in-script&amp;callback=getYouTubeDescription'></script>";
	}
