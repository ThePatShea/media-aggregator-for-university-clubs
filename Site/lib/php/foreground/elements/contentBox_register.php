	...
	echo "<div class='medBox'>";
		...
		echo "<div class='administration'>";
			...
			echo "<div class='topHeader'>";
				...
				{
					echo "manage your connected accounts";
				}
				else
				{
			...
			else if ($registerStep == 2 || $registerStep == 4 || $registerStep == 'accounts')
			{
					...
					{
						$manageFacebookID 				= $_GET['manageFacebookID'];
						$_SESSION['manageFacebookID'] 	= $manageFacebookID;
					}
					...
					if ($_SESSION['organizationFacebookID'])
					{
						...
						$fqlQuery		= "SELECT pic_square,pic_large FROM page WHERE page_id = $insertID ";
						$response		= $facebook->api(array('method' => 'fql.query','query' =>$fqlQuery));
						
						$user = $facebook->api("$insertID");
						
						$facebookLink 	= $user['link'];
						$pic_square		= $response[0]['pic_square'];
						$pic_big		= $response[0]['pic_large'];
						
						$query		= mysql_query("INSERT INTO users (facebookID, accountType, name, facebookLink, pic_square, pic_big) VALUES ('$insertID', 'organization', '$insertName', '$facebookLink', '$pic_square', '$pic_big')");
					}
					...
					function youtubeAuthenticationStart($facebookID)
					{
						if (authenticated())
						{
						    ...
						    $youTubeToken = $_SESSION['sessionToken'];
						    
						    $query = mysql_query("INSERT INTO tokens (accountFacebookID, token, site) VALUES ('$facebookID', '$youTubeToken', 'youtube')");
					...
					if(!empty($_SESSION)){
						...
						if(!empty($session)) {
							...
							if(!empty($uid)){
									...
									{
										$userFacebookID = $_SESSION['manageFacebookID'];
									}
									else
									{
									...
									error_reporting(0);	
										$tokenInfo = generateQueryArray("SELECT token from tokens WHERE accountFacebookID = $userFacebookID AND site = 'youtube' ");
									...
									echo "<div class='sectionHeader'>";
										...
										{
											echo "sync with other social media sites";
										}
									echo "</div>";
									
									echo "<div class='sectionText'>";
										if ($registerStep == 2 || $registerStep == 'accounts')
										{
										/*	
										...
										*/
											echo "The Emory Bubble allows you to sync your profile with your pre-existing YouTube videos. If you'd like to connect your YouTube account, just press the button.";
										...
										*/
											echo "The Emory Bubble allows you to sync your organization's profile with its pre-existing YouTube videos. If you'd like to connect your organization's YouTube account, just press the button.";
										}
									echo "</div>";
								...
								*/
									...
									echo "<div class='sectionHeader' style='margin-top: 20px;'>";
										echo "coming soon";
									echo "</div>";
									
									echo "<div class='sectionText'>";
										echo "The other social media sites are on their way. Soon, you'll be able to sync your Emory Bubble profile with your tweets, blog posts, and more.";
									echo "</div>";
									
									echo "<a class='registerIcon unselectableWithDefault' style='color: #666666; width: 55px; display: inline-block;'>";
										echo "<img style='display:block' src='lib/images/registerIcons/registerIcon_twitter.png'>";
										echo "Twitter";
									echo "</a>";
									...
									{
										echo "<a href='index.php' style='margin-top: 15px; position: relative; display:block; width: 25px; height: 5px;' class='greyButton'>";
											echo "done";
										echo "</a>";
									}
									else
