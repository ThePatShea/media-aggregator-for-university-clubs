...
ytVideoApp.prepareUploadForm = function() { 
  var  metaDataForm = ['<form id="uploadForm" ',
    ...
    'return false;">',
    'What is the title of your video?<br /><input size="50" name="videoTitle" ',
    'type="text" class="submitFormText" /><br />',
    'What is your video about?<br /><textarea cols="50" ',
    'name="videoDescription"></textarea><br />',
    'What category would you like your video to display on YouTube?<br /><select class="submitFormText" style="padding-right: 0;" name="videoCategory">',
    ...
    '</select><br /><br />',
    'What are some tags that describe your video?<br />',
    '<input name="videoTags" class="submitFormText" type="text" size="50" /><br />',
    '<input type="submit" value="next" class="greyButton unselectableWithPointer submitNextButton">',
    '</form>'].join('');
