<?php
	...
	"
		...
		<div id='teaserTabs' style='display: inline-block;'>
			<ul>";
				...
				for ($i = 1; $i <= $totalPages; $i++)
				{
					...
					echo "<li class='postTeaserPageNumbers' style='display: inline-block;'><a href='postTeaserTabs.php". $urlVariables . "startingRowArticle=$currentStartingRowArticle&startingRowGallery=$currentStartingRowGallery&startingRowVideo=$currentStartingRowVideo&startingRowEvent=$currentStartingRowEvent" ."' rel='flowerdivcontainer'>$pageNumber</a></li>";
...
<script type='text/javascript'>
	var myflowers=new ddajaxtabs('teaserTabs', 'teaserContainer')
