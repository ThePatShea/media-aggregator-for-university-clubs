...
function generateUrlInformation()
{
    if (!isset($_SESSION['operationsUrl']) || !isset($_SESSION['homeUrl'])) {
        ...
        $path[count($path)-1] = 'register2.php';
...
function generateAuthSubRequestLink($nextUrl = null)
{
    ...
    echo '<a class="registerIcon" style="color: #666666;" href="' . $url
        . '"><img style="display:block" src="lib/images/registerIcons/registerIcon_youtube.png">YouTube</a>';
